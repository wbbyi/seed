...
function initRuntimeSocketService() {
  const hosts = "192.168.56.1,10.72.54.192,192.168.248.1,192.168.150.1,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_Fifzqq";
